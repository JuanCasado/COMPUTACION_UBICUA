"use strict"; var _express = _interopRequireDefault(require("express")); var _mongoose = _interopRequireDefault(require("mongoose")); var _bodyParser = 
_interopRequireDefault(require("body-parser")); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; } // Connection 
and configuration. var app = (0, _express["default"])(); var port = 80; Mongoose.connect("mongodb://163.172.80.168:27018/smart_bed", {
    "user": "sensor_user",
    "pass": "sensor",
});
app.use(BodyParser.json()); app.use(BodyParser.urlencoded({ extended: true })); app.listen(port, () => {
